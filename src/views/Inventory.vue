<template>
  <v-container>
    <v-row justify="center">
      <v-btn color="red darken-1" @click.stop="adding = true">Add New Product</v-btn>
      <v-dialog v-model="adding" max-width="480">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer />
            <v-btn rounded color="purple darken-1" @click="clear">Cancel</v-btn>
            <v-btn rounded color="pink darken-1" @click="add">Add</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </v-row>
